...
[![CI](https://github.com/tgcz2011/FunnyCaptcha/actions/workflows/ci.yml/badge.svg)](https://github.com/tgcz2011/FunnyCaptcha/actions/workflows/ci.yml)
...
npx funnycaptcha
# 或全局安装
npm i -g @funnycaptcha/cli
funnycaptcha
```

在终端输入 `funnycaptcha` 即可自动打开浏览器，体验全部 10 种验证码。
...
```html
<script src="https://cdn.jsdelivr.net/npm/@funnycaptcha/embed/dist/embed.global.js"></script>
...
```bash
git clone https://github.com/tgcz2011/FunnyCaptcha.git
cd FunnyCaptcha
pnpm install
